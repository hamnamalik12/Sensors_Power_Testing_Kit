//Initialize the VL53L8CX sensor over I²C, configure it for 4×4 ranging at 5 Hz, and continuously print the 16 distance measurements in millimeters.
#include <stdio.h>
...
#define TOF_FREQUENCY_HZ          5     // frequency control (4x4 max is 60Hz)
...
void app_main(void) {
    ...
    ESP_LOGI(TAG, "Ranging started: 4x4, %d ms integration, %d Hz",
