//captures photo without deinitializing cam. 5 sec interval, only serial
...
// Change this to control how often a new frame is captured
...
extern "C" void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Camera initialized. Capturing every %d ms...", CAPTURE_INTERVAL_MS);
