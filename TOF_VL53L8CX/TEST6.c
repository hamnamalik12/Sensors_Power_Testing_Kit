//Initialize the VL53L8CX ToF sensor on the XIAO ESP32-S3, configure it for 8×8 ranging at 15 Hz, 
// continuously read 64 distance values, and print them over the serial terminal.
...
void app_main(void) {
    ...
    vl53l8cx_set_ranging_frequency_hz(&dev, 15);  // max for 8x8 mode
